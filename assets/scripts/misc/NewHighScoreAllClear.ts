...
@ccclass("NewHighScoreAllClear")
export class NewHighScoreAllClear extends Component {
    ...
    onHighAniPlay() {
        ...
        this.node.x = 0;
        this.sp.setCompleteListener((trackEntry: sp.spine.TrackEntry) => {
            this.node.x = -10000;
        });
        this.sp.setAnimation(0, "in", false);
    }
}
