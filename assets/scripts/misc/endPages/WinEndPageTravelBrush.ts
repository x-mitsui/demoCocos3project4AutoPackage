import { _decorator, dragonBones, Label, Node, Sprite, tween, UIOpacity, Vec3 } from "cc";
...
@ccclass("WinEndPageTravelBrush")
export class WinEndPageTravelBrush extends EndPage {
